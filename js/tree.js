(function () {
  ...
  const DATA = {
    maria: {
      name: "Мария",
      role: "бабушка • корень семьи",
      facts: [
        "Личный телохранитель Маши.",
        "Специалист по сопровождению “из точки А в точку Б”.",
    ...
    natasha: {
      ...
      quote: "“Сейчас разберёмся.”"
    },
    valya: {
      name: "Валя",
      role: "сестра Наташи • ветка семьи",
      facts: [
